          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="ms-3 ml-1.5 text-base">Productos</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                <svg
                  className="w-[22px] h-[22px] text-gray-500 transition duration-75  group-hover:text-gray-900"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                ...
                <span className="ms-3 ml-1.5 text-base">Categorías</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap ml-2 text-base">
                  Clientes
                </span>
              </a>
            </li>
            ...
            <li>
              <a
                href="Providers.jsp"
                className="flex items-center pr-2 py-2 pl-1.5 text-gray-900 rounded-lghover:bg-gray-100 group"
              >
                <svg
                  className="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900"
                  aria-hidden="true"
                ...
                <span className="flex-1 ms-3 whitespace-nowrap ml-1.5 text-base">
                  Proveedores
                </span>
              </a>
            </li>
            <li>
              <a
                href="#"
                className="flex items-center pr-2 py-2 pl-1.5 text-gray-900 rounded-lg hover:bg-gray-100 group"
              >
                <svg
                  className="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900"
                  aria-hidden="true"
